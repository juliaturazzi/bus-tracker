...
class TravelTimeService:
    ...
    def get_travel_times(
        self, bus_stop_coords: Dict[str, float], buses_info: List[Dict[str, Any]]
    ) -> List[Any]:
        try:
            locations = [[bus_stop_coords["lon"], bus_stop_coords["lat"]]] + [
...
def main():
    bus_stop_coords = {"lat": 40.785091, "lon": -73.968285}
